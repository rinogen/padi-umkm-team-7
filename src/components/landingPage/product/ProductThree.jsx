...
const ProductThree = () => {
  ...
  var settings = {
    ...
    speed: 500,
    slidesToShow: 5,
    draggable: false, // Nonaktifkan drag
    swipe: false, // Nonaktifkan swipe
    touchMove: false, // Nonaktifkan touch move
      ...
      <div className="container-layout lg:border lg:border-t lg:border-b-0 lg:border-x-0 ">
        <div className="flex justify-between pb-3 lg:py-4">
          <div className="flex items-center w-full justify-between">
            <div className="text-lg lg:text-[22px] font-bold">
              Koleksi Produk SEMARAK Souvenir
            </div>
        ...
        <div className="relative hidden md:flex flex-row w-full h-full">
          <Link
            ...
            style={{ backgroundColor: 'rgb(245, 240, 219)', height: '366px' }}
            ...
            <img
              ...
              src="https://padiumkm.id/_next/image?url=https%3A%2F%2Fsmb-padiumkm-images-public-prod.oss-ap-southeast-5.aliyuncs.com%2Fproduct-collection%2Fimage_section_banner%2F19082024%2Fkoleksi-produk-semarak-souvenir%2F93273766f66a898181e075d83f604f.png&w=3840&q=50"
            />
          </Link>
            ...
            <div className="slider-container h-full">
              <Slider {...settings}>
                {products.map((product) => {
                  ...
                  return (
                    product.promo &&
                    product.category.toLowerCase() === 'souvenir' && (
                      <div key={product.id}>
                        <div
          ...
          <div className="relative flex-1 w-full md:w-[994px] h-full">
            <div className="slider-container h-full">
              <Slider {...settings}>
                <Link to="https://padiumkm.id/collection/koleksi-produk-semarak-alat-tulis-kantor">
                  <div
                    className="px-2 pt-[1px] pb-[4px] "
                    style={{ width: '100%', display: 'inline-block' }}>
                    <div
                      className="flex flex-col justify-start h-full w-[173px] rounded-lg overflow-hidden bg-white font-ubuntu border border-[#DEE3ED] shadow-[1px_1px_5px_0_rgba(0,0,0,0.1)]"
                      style={{
                        backgroundColor: 'rgb(245, 240, 219)',
                        height: '360px',
                      }}>
